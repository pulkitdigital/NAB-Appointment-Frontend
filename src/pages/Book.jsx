...
//   // // 🆕 Pre-select CA from URL
//   // useEffect(() => {
//   //   const caIdFromURL = searchParams.get('ca_id');
//   //   if (caIdFromURL) {
//   //     console.log('🎯 Book.jsx: CA ID from URL:', caIdFromURL);
//   //     // Set it in formData
//   //     setFormData(prev => ({
//   //       ...prev,
//   //       ca_id: caIdFromURL
...
//   const caIdFromURL = searchParams.get('ca_id');
//   if (caIdFromURL) {
//     setFormData(prev => ({ ...prev, ca_id: caIdFromURL }));
//   }
// }, [searchParams]);
...
//                       Please select a Chartered Accountant from the form to view available time slots
//                     </p>
//                   </div>
//                 </div>
//               </motion.div>
...
//                 errors={errors}
//                 preSelectedCAId={searchParams.get('ca_id')}   // ✅ Yeh add karo
//               />
...
//                       </span>
//                       <span className="font-bold text-gray-900">
//                         {format(new Date(`2000-01-01T${selectedSlot}`), 'h:mm a')}
//                       </span>
//                     </div>
...
//                             )}
//                             <span className={selectedDate ? 'line-through' : 'font-medium'}>
...
//                             )}
//                             <span className={selectedDuration ? 'line-through' : 'font-medium'}>
...
//                             )}
//                             <span className={selectedSlot ? 'line-through' : 'font-medium'}>
